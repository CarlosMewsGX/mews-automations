...
const unfoldAutomations = [
  // ── Mar 3 – Mar 27 ──────────────────────────────────────────────────────────
  {
    ...
    status: "ON TRACK",
    progress: 95,
    notes: "Last bits of work being done, one issue remaining about \"Connecting Account\" in components when creating the template.",
  ...
  },
  {
    ...
    status: "ON TRACK",
    progress: 85,
    notes: "Adding pagination and pending \"Affected components\" information to be added to the logs",
  ...
  },
  {
    ...
    status: "ON TRACK",
    progress: 60,
    notes: "Still some backend work to send the notification to the PMS and we are working on displaying it in the \"bell\" in the PMS.",
  ...
  },
  {
    ...
    status: "ON TRACK",
    progress: 95,
    notes: "Adding multi-bookable service selector to some components and finishing \"Reservation Note\" component.",
  ...
  },
  {
    ...
    status: "ON TRACK",
    progress: 95,
    notes: "Reviewing everything is ready and just missing Appmixer production account",
  },
  {
    tab: "all",
    type: "gtm",
