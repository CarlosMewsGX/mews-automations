...
const unfoldAutomations = [
  ...
  },
  {
    tab: "revenue",
    type: "product",
    title: "Event based triggers and Zapier actions library",
    ...
    feature: "Event based triggers and Zapier actions library",
    status: "ON TRACK",
    progress: 25,
    notes: null,
  },
  ...
  // ── Jul 1 – Sep 30 ──────────────────────────────────────────────────────────
  {
    tab: "q3",
    type: "product",
    title: "Research before roadmapping",
    goal: "Run structured customer research with live pilot customers before building the next roadmap — not assumption-based prioritisation.",
    successCriteria: "Evaluation sessions completed with pilot customers. Captured: missing flows, missing connectors, missing triggers and actions, and friction points. Existing improvement proposals (e.g. soft deletes) validated against real customer desirability.",
    feature: "Customer Research",
    status: "NOT STARTED",
    progress: 0,
    notes: null,
  },
  {
    tab: "q3",
    type: "product",
    title: "Roadmap handoff package",
    goal: "Produce a prioritised backlog and short-term roadmap ready to hand off to whoever takes ownership after Unfold.",
    successCriteria: "Prioritised new connectors and flows defined. Validated improvement backlog documented. Onboarding and enablement materials prepared for the receiving team.",
  ...
  },
  {
    tab: "q3",
    type: "gtm",
    title: "Phase 2 — Public reveal and pipeline capture",
    goal: "Use Unfold (May 27, 2026) as an active capture moment to reveal the product publicly with pilot properties live in production and sign ~8 new properties for the next cohort.",
    successCriteria: "Product stable and representative at Unfold. Both pilot properties live in production. ~8 new properties committed to join as next cohort. Any bonus capabilities (e.g. CoPilot) only shown if mature — never at the cost of stability.",
    feature: "Unfold Launch",
    status: "NOT STARTED",
    progress: 0,
    notes: null,
  },
  {
    tab: "q3",
    type: "gtm",
    title: "Phase 3 — Staged General Availability",
    goal: "Open access progressively to all interested customers based on how the combined pool of live properties performs (Westcord + Strawberry + ~8 from Unfold).",
    successCriteria: "GA rollout paced by: stability signals from live properties, adoption metrics and feedback, team capacity and ownership clarity. Graduated GA as agreed.",
    feature: "GA Rollout",
    status: "NOT STARTED",
    progress: 0,
    notes: null,
